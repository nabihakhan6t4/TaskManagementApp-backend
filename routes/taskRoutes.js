...
router.post("/:id", protect, updateTask); // Update task details
router.delete("/:id", protect, adminOnly, deleteTask); // Delete a task (Admin nly)
router.post("/:id/status", protect, updateTaskStatus); // Update task status
router.post("/:id/todo", protect, updateTaskSChecklist); // Update task checklist
